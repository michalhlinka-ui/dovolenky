...
// ---- Email notify helper ----
const ADMIN_EMAILS = [
  "hlinka.michal@gmail.com" // ← sem daj 1–N admin e-mailov
];
...
// ... po await setDoc(...) alebo await deleteDoc(...)
const u = getUserById(state.currentUserId);
const action = (hrs === 0) ? 'zrušil žiadosť' : (myIdx === -1 ? 'vytvoril žiadosť' : 'upravil žiadosť');
